package io.github.jonasfschuh.aws_consumer.config.local;
...
public class DynamoDBConfigLocal {
    ...
    public DynamoDBConfigLocal() {
        LOG.info("DynamoDBConfigLocal loaded");
        ...
        com.amazonaws.services.dynamodbv2.document.DynamoDB dynamoDB = new com.amazonaws.services.dynamodbv2.document.DynamoDB(amazonDynamoDB);
        ...
        try {
            ...
            LOG.error("Error waiting for table to be created", e);
        }
